...
TOKEN = "BBFF-BkYKyla2IEUSDpFyvobvs35L3cvIFj"  # Put your TOKEN here
DEVICE_LABEL = "mansa-stars"  # Put your device label here 
VARIABLE_LABEL_1 = "temperature"  # Put your first variable label here
VARIABLE_LABEL_2 = "humidity"  # Put your second variable label here
VARIABLE_LABEL_3 = "position"  # Put your second variable label here
VARIABLE_LABEL_4 = "switch"  # Put your second variable label here


def build_payload(variable_1, variable_2, variable_3, variable_4):
    # Creates two random values for sending data
    value_1 = random.randint(40, 50) # temperature
    value_2 = random.randint(60, 85) # humidity
    value_4 = "Motor Bergerak"
